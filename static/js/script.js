...
document.addEventListener("DOMContentLoaded", function() {
  ...
  messageText.textContent = "Hello there, I'm Scott's AI avatar assistant, you can ask me anything about Scott's background, education, and working experiences. How can I help you?";
...
function processMessageLinksAndImages(messageText) {
  ...
  messageText.innerHTML = messageText.innerHTML.replace(urlRegex, function (url) {
    ...
    if (imageRegex.test(href)) {
      return '<img src="' + href + '" class="message-image" alt="Image from Scott" onclick="zoomImage(this.src)">';
    } else {
